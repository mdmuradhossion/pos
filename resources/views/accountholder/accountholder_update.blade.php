		...
		<div class="content-body">
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Account Holder Update</a></li>
			...
			<div class="container-fluid">
			    <div class="row">
					<div class="col-md-12">
			            <div class="card">
			                <div class="card-body">
			                    <h4 class="card-title">Account Holder Update</h4>
			                    ...
			                    <div class="tab-content br-n pn">
			                        <div id="navpills-1" class="tab-pane active">
			                            <div class="row align-items-center">
			                                <div class="col-12">
			                                    <form class="form-valide" action="{{ url('/account_holder_update',$view->acch_id)}}" method="post">
			                                    	@csrf
			                                        ...
			                                        <div class="form-group row">
			                                            <div class="col-lg-8 ml-auto">
			                                            	<input type="hidden" name="acch_id" value="{{$view->acch_id}}">
			                                                <button type="submit" class="btn btn-primary">Update</button>
			                                                <a href="{{url('/accountholder')}}" class="btn btn-warning">Cancel</a>
			                                            </div>
			                                        </div>
			                                    </form>
			                                </div>			                                
			                        ...
			                        <div id="navpills-2" class="tab-pane">
			                            <div class="row align-items-center">
			                                <div class="col-12">
			                                	<form class="form-valide" action="{{ url('/account_holder_update_image',$view->acch_id) }}" method="post" enctype="multipart/form-data" >
			                                    	{{csrf_field() }}
				                                	<div class="form-group row">
			                                            <label class="col-lg-4 col-form-label" for="name">Username <span class="text-danger">*</span>
			                                            </label>
